...
sample_questions = {
                ...
                "corrected_response": "a. C'est la manifestation de la micro-angiopathie diabétique. c. C'est l'affection vasculaire rétinienne la plus fréquente. d. Elle est toujours bilatérale." },
    {
           ...
           ,
            ...
            {
                "question": "Question: Which of the following is useful in management of choroidtis: Options: A. Antibiotics B. Steroids C. Miotics D. Padding",
                "corrected_response": "Ans. B: Steroid Choroiditis in included in posterior uveitis Coicosteroids, usually administered topically as drops or ointments or as subconjunctival injections, are of great value in controlling the inflammation in the acute phase of uveitis OPTION B IS CORRECT. "
            },
            {
                   "question": "Question: Which one of the following statements, concerning persistent hyperplastic primary vitreous (PHPV) is not true? Options: A. It is generally unilateral B. Visual prognosis is usually good C. It may calcify D. It is most easily differentiated from retinoblastoma by the presence of exophthalmos or cataract.",
                "corrected_response": "B i.e. Visual prognosis is usually good Persistent Hyperplastic Primary Vitreous (PHPV) It is persistence of the primary viterous & hyaloid aerial system. Almost always unilateralQ (-90%) Presents as white pupillary reflex in the new born (congenital leukocoria)Q It is usually associated with - CataractQ - Glaucoma - Long & extended ciliary processes because of pull from contracted retrolental tissue. - MicrophthalmosQ - Intraocular haemorrhage - Tractional RD Investigations: USG & CT Scan D/D with Retinoblastoma on the basis of microphthalmia & elongated ciliary processes If diagnosed early, T/T is aspiration of lens, excision of retrolental membrane and vitrectomy Visual prognosis is poorQ. OPTION B IS CORRECT."

            },
            {
                "question":"Question: What is the proof of eyes being open for a few hours after death – Options: A. Kevorkian sign B. Tache noir C. Both of the above D. None of the above",
                "corrected_response":"If eyes are open for few hours after death a film of cell debris and mucus forms two yellow triangles on sclera which turns brown then black. This is tache noir. Kevorkian sign is fragmentation of blood column in retinal vessels which occur in few minutes after death and last for an hour. OPTION B IS CORRECT."
            },
            {
                "question":"Question: In Von Hippel-Lindau Syndrome, the retinal vascular tumours are often associated with intracranial hemangioblastoma. Which one of the following regions is associated with such vascular abnormalities in this syndrome? Options: A. Optic radiation B. Optic tract C. Cerebellum D. Pulvinar",
                "corrected_response" :"OPTION C IS CORRECT"
            },
              {
                "question": "Question: All are true about congenital rubella syndrome, except– Options: A. Cardiac abnormality B. Renal anomalies C. Deafness D. Cataract",
                "corrected_response" : "OPTION B IS CORRECT."
            },
            {
                "question":"Question: All are true about congenital rubella syndrome, except– Options: A. Cardiac abnormality B. Renal anomalies C. Deafness D. Catarac",
                "corrected_response" : "OPTION B IS CORRECT. "
            }
            ],
     "General Ophthalmology QCM": [
  ...
  "corrected_response": "Option D: Thrombotic thrombocytopenic purpura (TTP) is the most likely diagnosis. It presents with microangiopathic hemolytic anemia, increased bleeding time, decreased platelet count, elevated indirect bilirubin and LDH, and characteristic findings on blood smear like schistocytes and helmet-shaped cells.",
     ...
     "corrected_response": "OPTION B IS CORRECT.",
...
},
        {
            ...
            "corrected_response": "OPTION C IS CORRECT."},
        {
            "question": " Question: An elderly male who has a history of glaucoma, on examination shows bulging of cornea. What is the diagnosis? Options: A. Keratoconus B. Staphyloma C. Glaucomatous iridocyclitis D. Keratomalacia",
            "corrected_response": "ANS. BStaphyloma is an abnormal protrusion of the uveal tissue through a weak point in the eyeball.There are 5 types of staphyloma.1. Anterior staphyloma2. Intercalary3. Ciliary4. Equatorial5. Posterior. OPTION B IS CORRECT"
        },
        {
            "question":"Question: A 3-day-old male infant has a noticeably small mandible. A CT scan and physical examinations reveal hypoplasia of the mandible, underdevelopment of the bones of the face, downward-slanting palpebral fissures, defects of the lower eyelids, and deformed external ears. Abnormal development of which of the pharyngeal arches will most likely produce such symptoms? Options: A. First arch B. Second arch C. Third arch D. Fourth arch"
             ,"corrected_response": "The first pharyngeal arch, which is often associated with the mandible, is responsible for development of Meckel's cartilage, malleus, incus, and mandible. Additionally, it is innervated by the trigeminal nerve, specifically the mandibular division that innervates the muscles of mastication. This patient presents with features characteristic of developmental defects in the first arch. The second pharyngeal arch gives rise to the stapes, styloid process, lesser cornu, Reichert's cartilage, and the upper half of the hyoid bone. It is innervated by the facial nerve. The third pharyngeal arch is responsible for formation of the greater cornu and the lower half of the hyoid bone and is innervated by the glossopharyngeal nerve. The fourth and sixth pharyngeal arches give rise to the laryngeal cartilages, in addition to being innervated by the vagus nerve. OPTION A IS CORRECT."
        },
        {
            "question":"Question: A 12-year-old boy presents with progressive clumsiness and difficulty walking. He walks like a 'drunken-man' and has experienced frequent falls. He was born at term and has gone through normal developmental milestones. His vaccination profile is up to date. He denies fever, chills, nausea, vomiting, chest pain, and shortness of breath. He has no history of alcohol use or illicit drug use. His elder brother experienced the same symptoms. The physical examination reveals normal higher mental functions. His extraocular movements are normal. His speech is mildly dysarthric. His muscle tone and strength in all 4 limbs are normal. His ankle reflexes are absent bilaterally with positive Babinski’s signs. Both vibration and proprioception are absent bilaterally. When he is asked to stand with his eyes closed and with both feet close together, he sways from side to side, unable to stand still. X-ray results show mild scoliosis. Electrocardiogram results show widespread T-wave inversions. His fasting blood glucose level is 143 mg/dL. What is the most likely diagnosis? Options: A. Ataxia-telangiectasia B. Charcot-Marie-Tooth disease C. Friedreich’s ataxia D. Myotonic dystrophy",
            "corrected_response": "OPTION C IS CORRECT."
        }
]
